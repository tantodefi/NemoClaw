...
- `nemoclaw-reference` — Network Policies (use the `nemoclaw-reference` skill) for the full baseline policy reference
- `nemoclaw-monitor-sandbox` — Monitor Sandbox Activity (use the `nemoclaw-monitor-sandbox` skill) for general sandbox monitoring
