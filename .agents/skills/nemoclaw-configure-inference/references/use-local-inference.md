...
- NemoClaw installed.
  Refer to the Quickstart (use the `nemoclaw-get-started` skill) if you have not installed yet.
...
into the image.
Refer to Switch Inference Models (use the `nemoclaw-configure-inference` skill) for details.
...
Refer to Switch Inference Models (use the `nemoclaw-configure-inference` skill) for the full procedure.
...
- Inference Options (use the `nemoclaw-configure-inference` skill) for the full list of providers available during onboarding.
- Switch Inference Models (use the `nemoclaw-configure-inference` skill) for runtime model switching.
- Quickstart (use the `nemoclaw-get-started` skill) for first-time installation.
