...
- chad-devflow.md (use the `nemoclaw-manage-operations` skill) — full wrapper catalog
- openwebui.md (use the `nemoclaw-manage-operations` skill) — underlying artifact surface
- wrapper-bugs.md (use the `nemoclaw-manage-operations` skill) — known issues + workarounds
