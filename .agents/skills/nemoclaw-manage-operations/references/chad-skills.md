...
- chad-devflow.md (use the `nemoclaw-manage-operations` skill) — registration mechanism in context.
- chad-autonomy.md (use the `nemoclaw-manage-operations` skill) — skill-discovery as autonomy loop #5.
