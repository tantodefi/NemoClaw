...
`wrapper-bugs.md` (use the `nemoclaw-manage-operations` skill).
...
Backup Policy (use the `nemoclaw-resources` skill) and the trust boundary
notes in `AGENTS.md` inside the workspace.

## Next steps

- Chad Devflow (use the `nemoclaw-manage-operations` skill) — primary operator commands.
- Backup and Restore (use the `nemoclaw-workspace` skill) — preserving chat
