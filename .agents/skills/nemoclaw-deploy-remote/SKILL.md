...
- `nemoclaw-monitor-sandbox` — Monitor Sandbox Activity (use the `nemoclaw-monitor-sandbox` skill) for sandbox monitoring tools
- `nemoclaw-reference` — Commands (use the `nemoclaw-reference` skill) for the full `deploy` command reference
