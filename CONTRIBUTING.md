...
Hand-authored operational workflows belong under `.github/skills/`. Use that path for repo-specific agent procedures, helper scripts, and non-doc skills that must not be regenerated by the docs pipeline.
