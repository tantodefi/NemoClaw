---
title:
  page: "NemoClaw Log Locations"
  nav: "Log Locations"
description:
  main: "Inventory of every log stream NemoClaw produces across host, sandbox, and gateway, plus how to dump them all in one shot."
  agent: "Catalog of host (Mac), sandbox (k8s pod), gateway, cron, sub-agent, and TUI logs. Use when debugging chad behavior or pointing the user at a specific log file."
keywords: ["nemoclaw logs", "chad logs", "openclaw debug", "dump-logs"]
topics: ["observability", "debugging"]
tags: ["openclaw", "openshell", "nemoclaw", "logs", "operations"]
content:
  type: reference
